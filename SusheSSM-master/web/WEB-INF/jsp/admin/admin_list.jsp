<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.su.pojo.Admin" %>
...
<%
        ...
        String message = (String)sess.getAttribute("edit_sucess");
...
<script>
    ...
    layui.use(['jquery', 'excel', 'form','layer','laydate'], function(){
        ...
        $("#addStudnetBtn").click(function () {
            layer.open({
                ...
                area:["50%"],
                anim:2,
                content:$("#test").html()       //显示添加框
            });
       $("#addEmployeeForm")[0].reset();
            form.on('submit(formDemo)', function(data) {
                // layer.msg('aaa',{icon:1,time:3000});
                var param=data.field;   //得到参数信息
    ...
    $(".updateEdit").click(function () {
        ...
        if (admin_id=="1"){    //如果是超级管理员即a_id=1,可以操作任何管理员，否则只能操作该管理员只能操作自己信息
            window.location.href = "/findAdminById?a_id=" + myid;
        } else if(admin_id != myid){   //如果不是超级管理员，判断是否是自己的信息，不是的话没有权限，是的话可以修改
