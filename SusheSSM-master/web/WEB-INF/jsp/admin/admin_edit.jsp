...
<div class="x-body">
  ...
  <div class="layui-form-item" id="btn_xg">
      <button  class="layui-btn" id="btn_on"   lay-filter="updateAdmin"  >
          修改
       </button>
<%--       <button  class="layui-btn"   onclick="fanhui()" >--%>
<%--           返回--%>
<%--        </button>--%>
      <input type="button" id="fh" class="layui-btn layui-btn-primary"    value="返回" onclick="fanhui()">
   </div>
    </form>
</div>
