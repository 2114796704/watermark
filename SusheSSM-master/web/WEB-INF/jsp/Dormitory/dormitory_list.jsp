...
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.su.pojo.Dormitory" %>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findDormitory" >
            <input class="layui-input" placeholder="请输入核酸采集点编号" name="s_dormitoryid" id="s_dormitoryid" value="${s_dormitoryid}">
            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_dormitoryid" class="layui-input" placeholder="请输入核酸采集点编号">
                    </div>
                </div>
        ...
        form.on('submit(toolbarDemo)', function(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // 2. 数组头部新增表头
                    dt.unshift({d_id: 'ID', s_dormitoryid: '核酸采集点编号', d_dormbuilding: '宿舍楼', d_bedtotal: '床位总数', d_bed: '医用床位', a_name: '管理员'});
