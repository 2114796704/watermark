...
<%@ page contentType="text/html;charset=UTF-8" language="java" import="com.su.pojo.Visitor" %>
        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">监控人员姓名：</label>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">监控人员电话：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="v_dormitoryid" class="layui-input" placeholder="请输入核酸采集点编号">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">监控人员核酸采集点：</label>
                    <div class="layui-input-block">
                        <input type="text" name="v_dormbuilding"  class="layui-input" placeholder="请输入核酸采集点">
                    </div>
                </div>
        ...
        form.on('submit(toolbarDemo)', function(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // 2. 数组头部新增表头
                    dt.unshift({v_id: 'ID', v_name: '监控人员姓名', v_phone: '监控人员电话', v_dormitoryid: '监控人员核酸采集点编号', v_dormbuilding: '监控人员核酸采集点', create_time: '监控人员时间'});
