...
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.su.pojo.DormRepair" %>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findDormRepair" >
            <input class="layui-input" placeholder="请输入核酸采集点编号" name="d_id" id="d_id" value="${d_id}">
            <input class="layui-input" placeholder="请输入采集点" name="d_dormbuilding" id="d_dormbuilding" value="${d_dormbuilding}">
        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    <label class="layui-form-label">核酸采集点编号：</label>
                    <div class="layui-input-block">
                        <input type="text" name="d_id" class="layui-input" placeholder="请输入核酸采集点编号">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">核酸采集点：</label>
                    <div class="layui-input-block">
                        <input type="text" name="d_dormbuilding" class="layui-input" placeholder="请输入核酸采集点">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">核酸人员：</label>
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="r_name"  class="layui-input" placeholder="请输入核酸人员">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">核酸检测人员</s：</label>
                    <div class="layui-input-block">
                        <input type="text" name="reason" class="layui-input" placeholder="请输入核酸检测人员</s">
                    </div>
                </div>
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 2. 数组头部新增表头
                        dt.unshift({r_id: 'ID', d_id: '核酸采集点编号', d_dormbuilding: '核酸采集点', r_name: '核酸人员', reason: '核酸检测人员</s', create_time: '检测时间', update_time: '更新时间'});
