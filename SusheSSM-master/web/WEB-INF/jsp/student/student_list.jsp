<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.su.pojo.Student" %>
...
<script>
    ...
    layui.use(['jquery', 'excel','form','layer','laydate'], function(){
        ...
        $("#addStudnetBtn").click(function () {
            ...
            $("#addEmployeeForm")[0].reset(); //能够在单选框选择，否则选择男女无法点击
    ...
    //编辑弹出框
    function updateEdit(s_id){
/* 存在一个问题
*  ajax请求后端改变一个session，需要刷新一下，才会改变成功（session传入前端）
* 否则，后端session 改变，前端还是之前session会话窗口
* */
        // $.ajax({
        //      url:'/findStudentById?s_id='+s_id,
        //     type:'get',
        //     success:function (data){
    ...
    function member_del(obj,s_id){
        layer.confirm('确认要删除吗？',function(){
            //发异步删除数据
           $.get("/deleteStudent",{"s_id":s_id},function (data,status) {
                if(status=="success"){
