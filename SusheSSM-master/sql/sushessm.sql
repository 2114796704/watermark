/*
 ...
 Source Schema         : sushessm

 Target Server Type    : MySQL
 Target Server Version : 80023
 File Encoding         : 65001

 Date: 13/08/2021 17:57:18
*/
...
CREATE TABLE `d_admin`  (
  ...
  `a_username` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `a_password` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `a_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `a_phone` bigint(0) NULL DEFAULT NULL,
  `a_power` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `a_describe` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
INSERT INTO `d_admin` VALUES (5, 'yww', 'D9840773233FA6B19FDE8CAF765402F5', '杨雯雯99', 22222, '1', '高');
...
INSERT INTO `d_admin` VALUES (12, 'xl', '696E25FDACEE8106BC5232AFC69155D6', '薛磊', 122222, '2', '低');
INSERT INTO `d_admin` VALUES (13, '2', '1', '1', 1, '1', '1');
INSERT INTO `d_admin` VALUES (16, '1', 'C4CA4238A0B923820DCC509A6F75849B', '1', 1, '2', '低');
...
CREATE TABLE `d_class`  (
  ...
  `c_classname` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `c_counsellor` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `d_dormgrade`  (
  ...
  `d_id` int(0) NOT NULL,
  `d_dormbuilding` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `d_dormitoryinfo`  (
  ...
  `d_dormbuilding` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `d_bedtotal` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `d_bed` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `a_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `d_dormrepair`  (
  ...
  `d_id` int(0) NOT NULL,
  `d_dormbuilding` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `r_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `reason` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `d_stgrade`  (
  ...
  `s_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `d_student`  (
  ...
  `s_classname` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `s_dormitoryid` int(0) NOT NULL,
...
INSERT INTO `d_student` VALUES (14, 1, '1', '男', 1, 1, 1, '1', 1);
INSERT INTO `d_student` VALUES (15, 2, '2', '男', 2, 2, 2, '2', 2);
INSERT INTO `d_student` VALUES (16, 3, '11', '男', 11, 11, 11, '3', 3);
INSERT INTO `d_student` VALUES (17, 5, '1', '男', 1, 1, 1, '1', 1);
...
CREATE TABLE `d_visitor`  (
  ...
  `v_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `v_phone` bigint(0) NULL DEFAULT NULL,
  `v_dormitoryid` int(0) NULL DEFAULT NULL,
  `v_dormbuilding` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
