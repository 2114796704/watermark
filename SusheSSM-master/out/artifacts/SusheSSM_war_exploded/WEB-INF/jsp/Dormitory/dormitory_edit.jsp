...
<div class="x-body">
    <form class="layui-form"  id="f_auto" action="/updateDormitory" method="post" >
        ...
        <div class="layui-form-item" id="btn_xg">
            ...
            <button  type="reset" onclick="javascript:a()"
                     class="layui-btn"   lay-submit="" lay-filter="updateClass">
              返回
            </button>
...
<script>
    function a(){window.history.back(-1)}
</script>
</body>
</html>
