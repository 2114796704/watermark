...
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.su.pojo.DormClean" %>
...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/findDormClean">核酸采集点信息</a>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findDormClean" >
            ...
            <input class="layui-input" placeholder="请输入核酸采集点" name="d_dormbuilding" id="d_dormbuilding" value="${d_dormbuilding}">
    ...
    <div class="layui-row" id="test" style="display: none;">
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">核酸采集点信息：</label>
                    <div class="layui-input-block">
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 2. 数组头部新增表头
                        dt.unshift({g_id: 'ID', d_id: '核酸采集点编号', d_dormbuilding: '核酸采集点', d_grade: '核酸采集点信息', create_time: '创建日期', update_time: '更新日期'});
