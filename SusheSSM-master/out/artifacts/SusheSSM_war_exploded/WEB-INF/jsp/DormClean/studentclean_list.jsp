<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.su.pojo.StudentClean" %>
    ...
    <div class="layui-row" id="test" style="display: none;">
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">学生核酸信息：</label>
                    <div class="layui-input-block">
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 2. 数组头部新增表头
                        dt.unshift({g_id: 'ID', s_studentid: '学号', s_name: '姓名', s_grade: '学生核酸信息', s_classid: '班级编号', s_dormitoryid: '核酸采集点编号', create_time: '创建日期', update_time: '更新日期'});
